...
<a href="${ctx}/system/message/toQueryPage.do?type=recived">
<b class="h_tabpitchbtn_r c_222 pr25 w_auto f14 block fr lh32 cp id_nav pr">
接收信息 </b></a>
</li>
<li>
             ...
             <td>
                   <c:choose>
                		<c:when test="${VS_HAS_FUNCTIONS.messageView}">
                			<a class="toviewpage" href="${ctx}/system/message/toViewPage.do?id={$T.row.id}&userName={$T.row.message.creater.realName}">{$T.row.message.title}</a>
                		</c:when>

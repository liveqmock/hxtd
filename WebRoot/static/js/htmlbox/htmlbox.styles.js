...
return [
	...
	'</td><td style="border-top:1px solid #b8b8b8;border-right:1px solid #b8b8b8;font-size:1px;width:21px;height:17px;">&nbsp;</td></tr><tr><td width="*" style="border-bottom:1px solid #b8b8b8;border-left:1px solid #b8b8b8;font-size:1px;">&nbsp;</td><td style="width:21px;height:17px;"><img src="'+jsUtil.getRootPath()+'"/static/js/htmlbox/images/corner.gif" style="width:21px;height:17px;"></td></tr></table><br />'
	]
];
};
            ...
            <form name="user" action="${ctx}${VR_FUNCTION.url}" method="post">
                ...
                <div class="cb block h40 margin0 mt10" style="width:350px;">
                    <ul class="id_table1 cb">
                        ...
                        <li><a href="${ctx}/system/${type}/toQueryPage.do" class="block c_white lh25 mr10"><b class="allbtn_l block fl"></b><b class="allbtn_r pr13 block fl w_auto f14">取消</b></a></li>
                    </ul>
                </div>
            </form>
        </div>

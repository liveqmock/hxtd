      ...
      <ul class="fl id_table3 w block cb mt10 tab-titles" style="border-bottom:5px solid #626262; height:32px;" fortabpanels>
        ...
        <li class="tab-title" fortabpanel="#tabs-send">
         ...
         <ul class="fr id_table1  ml10">
             ...
             <li><a href="${ctx}/system/message/toQueryPage.do?type=revice" class="block c_white lh25 fr mr10 submit">
	         <b class="allbtn_l block fl"></b>
            ...
            <tr class="{$T.row$index%2==1?'':'bg_c_blue w'}">
             ...
             <td align="left">
                ...
                <td align="left">
                        ...
                        {#if $T.row.type}
                        <a href="${ctx}/system/message/toViewPage.do?id={$T.row.id}&type=add"

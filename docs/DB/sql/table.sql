...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='附件表';
...
CREATE TABLE `contract` (
  ...
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE,
  KEY `INDEX_MODIFIED_TIME` (`MODIFIED_TIME`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='合同表';
...
CREATE TABLE `lead` (
  ...
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2133 DEFAULT CHARSET=utf8 COMMENT='线索';
...
CREATE TABLE `payments` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='付款表';
...
CREATE TABLE `report` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='报表表';
...
) ENGINE=InnoDB AUTO_INCREMENT=966 DEFAULT CHARSET=utf8 COMMENT='审计日志表';
...
CREATE TABLE `sm_dictionary` (
  ...
  `MODIFIED_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后修改时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=900019907 DEFAULT CHARSET=utf8 COMMENT='数据字典表';
...
CREATE TABLE `sm_recyclebin` (
  ...
  KEY `INDEX_MODULE_NAME` (`MODULE_NAME`) USING BTREE,
  KEY `INDEX_CREATED_TIME` (`CREATED_TIME`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=202 DEFAULT CHARSET=utf8 COMMENT='回收站表';
...
CREATE TABLE `sm_workbanch` (
  ...
  `MODIFIED_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='工作台';
...
CREATE TABLE `sysmessage` (
  ...
  KEY `INDEX_CREATOR_ID` (`CREATOR_ID`) USING BTREE,
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='系统消息';
...
CREATE TABLE `user_message` (
  ...
  KEY `INDEX_TYPE` (`TYPE`) USING BTREE,
  KEY `INDEX_CREATED_TIME` (`CREATED_TIME`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='系统消息与用户关联表';
...
CREATE TABLE `wf_node` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `INDEX_CODE` (`CODE`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='流程节点表';
...
CREATE TABLE `wf_task` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8 COMMENT='流程任务表';

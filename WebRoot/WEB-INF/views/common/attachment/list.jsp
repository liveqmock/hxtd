...
<script type="text/javascript" src="${ctx}/static/js/scrollTitle.js?v=1"></script>
    <script type="text/javascript">
        $(function () {
            var grid = new Grid().init().bindAuthorization();
        });
         //加载时间控件
...
<div class=" listcontainer">
    ...
    <form id="form" action="${ctx}/common/attach/query.do" onsubmit="return false;">
      ...
      <tr>
      <td class="f14" align="right" width="7%">附件名称：</td>
...
<div id="title" style="display: none;background-color: #f5f5f6;" class=" ml35 mr35">
                ...
                <th  width="8%"  class="sortable orderby" orderby="name">附件名</th>
                <th width="25%" >存储地址</th>
                <th width="10%" >上传者</th>
                <th width="10%">修改者</th>
                <th width="15%"  class="sortable orderby" orderby="createdTime">上传时间</th>
    ...
    <div class="ml35 mr35">
        ...
        <textarea id="template-tbody" class="template template-tbody">
            ...
            <tr class="{$T.row$index%2==1?'':'bg_c_blue w'}">
                <td align="center"><input type="checkbox" class="checkitem" value="{$T.row.id}"/></td>

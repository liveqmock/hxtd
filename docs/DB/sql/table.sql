...
CREATE TABLE `contact` (
  ...
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='联系人';
...
CREATE TABLE `lead` (
  ...
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='线索';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='市场活动';
...
CREATE TABLE `sales_target` (
  ...
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE,
  KEY `INDEX_MODIFIED_TIME` (`MODIFIED_TIME`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='销售目标表';

-- ----------------------------
-- Records of sales_target
-- ----------------------------
INSERT INTO sales_target VALUES ('17', '5', '30.0000', '', '1', '2014-07-24 16:58:22', '1', '2014-07-24 16:58:22', '2014-08-01 00:00:00', '2014-08-31 23:59:59', '0', '2014年 8月', '8月份第一团队销售目标');
INSERT INTO sales_target VALUES ('18', '6', '30.0000', '', '1', '2014-07-24 14:38:01', '1', '2014-07-24 14:38:01', '2014-08-01 00:00:00', '2014-08-31 23:59:59', '0', '2014年 8月', '8月份第一团队销售目标');
INSERT INTO sales_target VALUES ('19', '2', '123.0000', '爱仕达', '1', '2014-07-24 16:50:38', '1', '2014-07-24 16:50:38', '2014-01-01 00:00:00', '2014-03-31 23:59:59', '0', '2014年 1-3月', '测试');
INSERT INTO sales_target VALUES ('20', '3', '123.0000', '爱仕达', '1', '2014-07-24 16:50:38', '1', '2014-07-24 16:50:38', '2014-01-01 00:00:00', '2014-03-31 23:59:59', '0', '2014年 1-3月', '测试');
...
) ENGINE=InnoDB AUTO_INCREMENT=240 DEFAULT CHARSET=utf8 COMMENT='审计日志表';
...
CREATE TABLE `sm_function` (
  ...
  KEY `INDEX_CREATOR_ID` (`CREATOR_ID`) USING BTREE,
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=269 DEFAULT CHARSET=utf8 COMMENT='功能表';
...
) ENGINE=InnoDB AUTO_INCREMENT=108 DEFAULT CHARSET=utf8 COMMENT='机构表';
...
CREATE TABLE `sm_recyclebin` (
  ...
  KEY `INDEX_MODULE_NAME` (`MODULE_NAME`) USING BTREE,
  KEY `INDEX_CREATED_TIME` (`CREATED_TIME`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='回收站表';
...
CREATE TABLE `sm_workbanch` (
  ...
  `MODIFIED_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='工作台';
...
CREATE TABLE `sysmessage` (
  ...
  KEY `INDEX_CREATOR_ID` (`CREATOR_ID`) USING BTREE,
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='系统消息';
...
CREATE TABLE `user_message` (
  ...
  KEY `INDEX_TYPE` (`TYPE`) USING BTREE,
  KEY `INDEX_CREATED_TIME` (`CREATED_TIME`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='系统消息与用户关联表';

...
<div><!--请在此处使用iframe--->
    ...
    <div class="ml35 mr35 bg_c_blue cb">
        ...
        <table class="cb id_table3 w95b bg_c_white margin0 mt10">
            ...
            <tr>
                ...
                <td align="left"><input type="text" name="phone" value="${com.phone}" class="text_input3 isPhone"></td>
    ...
    <div class="cb block h40 margin0 mt10" style="width:350px;">
        <ul class="id_table1 cb">
            ...
            <li><a href="${ctx}/project/supplier/toQueryPage.do"  class="block c_white lh25"><b class="allbtn_l block fl"></b><b class="allbtn_r pr13 block fl w_auto f14">取&nbsp&nbsp消</b></a></li>
        </ul>
    </div>

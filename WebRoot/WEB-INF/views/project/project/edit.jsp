...
<div><!--请在此处使用iframe--->
    ...
    <div class="ml35 mr35 bg_c_blue cb">
        ...
        <table class="cb id_table3 w95b bg_c_white margin0 mt10">
            ...
            <tr>
                <td align="right" width="15%">项目名：</td>
                <td align="left"><input type="text" name="name" value="${project.name }" class="text_input3 required"></td>
                <td align="right" width="15%">项目编号：</td>
                <td align="left"><input type="text" name="code" value="${project.code }" class="text_input3 required"></td>
            </tr>

            <tr>
                <td align="right">融资额度：</td>
                <td align="left"><input type="text" name="financeLimit" value="${project.financeLimit }" class="text_input3 number"></td>
                <td align="right">开始时间：</td>
                <td align="left">
                 <fmt:formatDate value="${project.beginTime }" pattern="yyyy-MM-dd" var="beginTime"/>
                 <input type="text" value="${beginTime }" name="beginTime" class="time text_input3"></td>
            </tr>

            <tr>
                <td align="right">融资前周期(天)：</td>
                <td align="left"><input type="text" name="beforeFinanceCycle" value="${project.beforeFinanceCycle }" class="text_input3 number"></td>
                <td align="right">截止时间：</td>
                <td align="left">
                <fmt:formatDate value="${project.dendlineTime}" pattern="yyyy-MM-dd" var="dendlineTime"/>
                <input type="text" value="${dendlineTime}" name="dendlineTime" class="time text_input3"></td>
            </tr>

            <tr>
                <td align="right">融资周期：</td>
                <td align="left"><input type="text" name="financeCycle" value="${project.financeCycle }" class="text_input3 number"></td>
                <td align="right">收益率：</td>
                <td align="left"><input type="text" name="er" value="${project.er }" class="text_input3 number">%</td>
            </tr>
            
             <tr>
                <td align="right">支付方式：</td>
                <td align="left"><input type="text" name="payType" value="${project.payType }" class="text_input3"></td>
                <td align="right">提前赎回率：</td>
                <td align="left"><input type="text" name="aer" value="${project.aer }" class="text_input3 number">%</td>
            </tr>
            
             <tr>
                <td align="right">供应商：</td>
                <td align="left"><input type="text" id="txt_supplier" readonly onclick="searchData('supplier')" value="${project.supplier.name }" class="text_input3 required">
                ...
                <input type="text" value="${openTime}" name="openTime" class="text_input3 time"></td>
            </tr>
        ...
        <table class="cb id_table4 w95b bg_c_white margin0 mt10">
            <tr>
                ...
                <td align="left" width="85%"><textarea name="remark"  class="remarks_input1">${project.remark}</textarea></td>
    ...
    <div class="cb block h40 margin0 mt10" style="width:350px;">
        <ul class="id_table1 cb">
            ...
            <li><a href="${ctx}/project/project/toQueryPage.do"  class="block c_white lh25"><b class="allbtn_l block fl"></b><b class="allbtn_r pr13 block fl w_auto f14">取&nbsp&nbsp消</b></a></li>
        </ul>
    </div>
</div>

...
INSERT INTO lead VALUES ('2', '9', '百会7', '罗晓丽4', '研发中心9', '', '362350061@qq.com', '010-82147300', '010-82147300', '18600884613', '92', '102', null, '224', '1011400250354140', '142', '100001', '420000', '420300', null, '花园北路14号环星大厦D座二楼1', '无2', '0', '1', '2014-08-07 14:48:40', '1', '2014-08-07 14:48:40');
...
INSERT INTO market_activity VALUES ('7', '含有金额的市场活动', '72', '82', '2014-08-05 00:00:00', '2014-08-05 00:00:00', '1000.0000', '1000.0000', '1', '', '0.00', '10', '10', '含有金额的市场活动', '0', '0', '10', '2014-08-05 12:00:07', '10', '2014-08-05 12:00:08', '9');
...
-- Records of order
-- ----------------------------
INSERT INTO order VALUES ('9', '1', '1', '2014072704', '1', '263', '130.00', '2', '15', 'a*2-2000', '10', '7', '10', '2014-09-07 00:00:00', '130w购买理财产品', '0', '7', '2014-07-27 23:18:08', '7', '2014-07-27 23:18:08', '0', '27', '34', null);
INSERT INTO order VALUES ('10', '3', '1', '20140725001', '1', '262', '160.00', '20', '36', 'a*(1-0.1)+1000', '10', '7', '8', '2014-10-12 00:00:00', '160w购买理财产品', '0', '10', '2014-07-27 23:37:46', '10', '2014-07-27 23:37:46', '0', '27', '35', null);
INSERT INTO order VALUES ('11', '4', '1', '2014072701', '1', '262', '100.00', '0', '1', 'a*0.5', '10', '7', '9', '2014-10-31 00:00:00', '', '0', '10', '2014-07-28 00:03:26', '10', '2014-07-28 00:03:26', '0', '27', '35', null);
INSERT INTO order VALUES ('12', '1', '1', '20140727005', '1', '263', '200.00', '2', '2', 'a*2-2000', '10', '8', '10', '2014-08-09 00:00:00', '', '0', '10', '2014-07-28 16:52:11', '10', '2014-07-28 16:52:11', '0', null, '346', null);
INSERT INTO order VALUES ('13', '1', '1', '2014072503', '1', '263', '199.00', '2', '2', 'a*2-2000', '10', '8', '10', '2014-08-09 00:00:00', '', '0', '10', '2014-07-28 00:12:01', '10', '2014-07-28 00:12:01', '0', '27', '37', null);
INSERT INTO order VALUES ('14', '2', '1', '20140730001', '1', '262', '100.00', '10', '12', 'a*0.1+1000', '10', '2', '3', '2014-08-09 00:00:00', '', '0', '1', '2014-07-30 16:43:12', '1', '2014-07-30 16:43:12', '0', '27', '37', null);
INSERT INTO order VALUES ('15', '1', '1', '00001', '1', '262', '100.00', '2', '1', 'a*2-2000', '10', '8', '2', '2014-08-09 00:00:00', '11', '0', '1', '2014-08-06 17:16:05', '1', '2014-08-06 17:16:05', '0', '26', '32', null);
...
INSERT INTO product VALUES ('2', '东北大庆油田一期02', '140727DQ00101Y', '1', '343', '150.00', '10.00', '5.00', '6', '65', '2014-07-31 00:00:00', '2014-08-31 00:00:00', '5.00', 'a*0.1+1000', '', '0', null, '10', '2014-07-27 21:41:49', '1', '2014-08-06 18:26:39');
...
INSERT INTO product VALUES ('4', '东北大庆油田一期03', '140727DQ00101H', '1', '343', '130.00', '0.20', '0.60', '3', '65', '2014-07-31 00:00:00', '2014-08-08 00:00:00', '0.50', 'a*0.5', '', '0', null, '10', '2014-07-27 21:57:29', '1', '2014-08-06 19:07:52');
...
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8 COMMENT='审计日志表';
...
CREATE TABLE `sm_component` (
  ...
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE,
  KEY `INDEX_CREATOR_ID` (`CREATOR_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='组件表';
...
INSERT INTO sm_dictionary VALUES ('347', '测试字典', '007007', '28', '0', '0', '赎回方式', '1', '测试字典', '1', '0', '1', '2014-08-01 09:20:05', '1', '2014-08-07 17:05:36');
...
CREATE TABLE `sm_function` (
  ...
  KEY `INDEX_CREATOR_ID` (`CREATOR_ID`) USING BTREE,
  KEY `INDEX_MODIFIER_ID` (`MODIFIER_ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=331 DEFAULT CHARSET=utf8 COMMENT='功能表';
...
CREATE TABLE `sm_menu` (
  ...
  KEY `INDEX_URL` (`URL`)
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='菜单表';
...
CREATE TABLE `sm_recyclebin` (
  ...
  KEY `INDEX_MODULE_NAME` (`MODULE_NAME`) USING BTREE,
  KEY `INDEX_CREATED_TIME` (`CREATED_TIME`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='回收站表';
...
INSERT INTO sm_recyclebin VALUES ('29', 'dictionary', '347', '测试字典', '字典删除', '1', '2014-08-07 17:06:37');
...
INSERT INTO sm_user_com VALUES ('12', '1');
INSERT INTO sm_user_com VALUES ('12', '2');
INSERT INTO sm_user_com VALUES ('12', '3');
...
INSERT INTO sm_user_func VALUES ('2', '12');
...
INSERT INTO sm_user_func VALUES ('2', '18');
...
INSERT INTO sm_user_func VALUES ('2', '309');
...
INSERT INTO sm_user_func VALUES ('12', '177');
INSERT INTO sm_user_func VALUES ('12', '178');
INSERT INTO sm_user_func VALUES ('12', '179');
INSERT INTO sm_user_func VALUES ('12', '180');
INSERT INTO sm_user_func VALUES ('12', '181');
INSERT INTO sm_user_func VALUES ('12', '182');
INSERT INTO sm_user_func VALUES ('12', '183');
INSERT INTO sm_user_func VALUES ('12', '184');
INSERT INTO sm_user_func VALUES ('12', '185');
INSERT INTO sm_user_func VALUES ('12', '186');
INSERT INTO sm_user_func VALUES ('12', '187');
INSERT INTO sm_user_func VALUES ('12', '188');
INSERT INTO sm_user_func VALUES ('12', '189');
INSERT INTO sm_user_func VALUES ('12', '190');
INSERT INTO sm_user_func VALUES ('12', '214');
INSERT INTO sm_user_func VALUES ('12', '305');
INSERT INTO sm_user_func VALUES ('12', '306');
INSERT INTO sm_user_func VALUES ('12', '307');
...
INSERT INTO sm_user_role VALUES ('2', '6');
INSERT INTO sm_user_role VALUES ('2', '7');
...
INSERT INTO sm_user_role VALUES ('11', '9');

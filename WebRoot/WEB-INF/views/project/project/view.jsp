    ...
    <div class="ml35 mr35 mt20 block cb cb">
       ...
       <b class="b4"></b>
        <div class="ie_head" >
            ...
            <li><a class=" pl35 c_white f14 lh25 cp block fr" href="${ctx }/project/project/toModifyPage.do?id=${com.id}"><b class="allbtn_l block fl"></b><b class="allbtn_r pr13 block fl w_auto f14">编&nbsp;&nbsp;辑</b></a></li>
        ...
        <table class="cb id_table3 w95b bg_c_white margin0 mt10">
            ...
            <tr>
             ...
             <tr>
                ...
                <td align="left">${project.payType }</td>

...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            jsUtil.datepickerAll('.time', 'max', 0);
            ...
            var timeType = form.find(".timetype");
            timeType.change(function () {
                var option = $(this).find(":selected");
                min.val(option.attr("data-min"));
                max.val(option.attr("data-max"));
            }).change();
            ...
            <tr>
                    ...
                    <div class="pr">
                        <select class="select2 pr timetype">
                            <c:forEach items="${timeTypes}" var="entity">
                                <fmt:formatDate value="${entity.value.minimum}" pattern="yyyy-MM-dd HH:mm" var="min"/>
                                <fmt:formatDate value="${entity.value.maximum}" pattern="yyyy-MM-dd HH:mm" var="max"/>
                                <option data-min="${min}" data-max="${max}">${entity.key}</option>
                            </c:forEach>
                        </select>
                    </div>
                </td>
                ...
                <td class="f14" align="left" width="24%">
                    <div class="vm">
                        ...
                        -
                        <input type="text" data-name="search_LTE_" value="${time}" class="text_input2 input_close3 globle_img untime time" readonly/>
                    </div>
                </td>
                <td width="12%">

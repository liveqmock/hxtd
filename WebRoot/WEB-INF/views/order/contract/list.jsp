      ...
      <table class="fl mt5 w">
       <tr>   
		...
		<tr class="more-content">
			...
			<td class="f14 namewidth2" align="left">
			<div class="vm">
			<input class="text_input2 input_close globle_img time" name="search_GTE_signTime" type="text" readonly/>-<input class="text_input2 input_close globle_img time" name="search_LTE_signTime" type="text" readonly/>
			</div>
			</td>
			<td class="f14 namewidth1" align="right">生效时间：</td>
			<td class="f14 namewidth2" align="left">
			<div class="vm">
			<input class="text_input2 input_close globle_img time" name="search_GTE_effectTime" type="text" readonly/>-<input class="text_input2 input_close globle_img time" name="search_LTE_effectTime" type="text" readonly/>
			</div>
			</td>
			<td class="f14 namewidth1" align="right">失效时间：</td>
			<td class="f14 namewidth2" align="left">
			<div class="vm">
			<input class="text_input2 input_close globle_img time" name="search_GTE_bereftTime" type="text" readonly/>-<input class="text_input2 input_close globle_img time" name="search_LTE_bereftTime" type="text" readonly/>
			</div>
			</td>
		</tr>
	    </tr>  
